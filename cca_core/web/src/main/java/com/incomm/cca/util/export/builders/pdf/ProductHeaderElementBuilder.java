...
public class ProductHeaderElementBuilder extends GenericHeaderElementBuilder {

    private EnhancedCard card;

    public ProductHeaderElementBuilder(EnhancedCard card) {
        this.card = card;
    }
    ...
    public Element build(Document document) {
        ...
        header.appendChild(buildHeaderContentElement(document, "CCA Product Report", String.format("Serial #: %s", card.getIdentifiers()
                                                                                                                       .getSerialNumber()), card.getProductGroup()));
