...
@Component ( {
  selector: 'cca-ccl-gift-search-results-table',
  templateUrl: './ccl-gift-search-results-table.component.html',
  styleUrls: [ './ccl-gift-search-results-table.component.scss' ]
} )
export class CclGiftSearchResultsTableComponent extends AbstractSearchResultsTableComponent implements OnInit {
