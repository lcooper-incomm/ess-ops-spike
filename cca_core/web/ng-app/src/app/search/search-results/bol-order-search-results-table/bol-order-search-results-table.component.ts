...
@Component ( {
  selector: 'cca-bol-order-search-results-table',
  templateUrl: './bol-order-search-results-table.component.html',
  styleUrls: [ './bol-order-search-results-table.component.scss' ]
} )
export class BolOrderSearchResultsTableComponent extends AbstractSearchResultsTableComponent implements OnInit {
