...
set JCE_PROVIDER="providerClassName=org.bouncycastle.jce.provider.BouncyCastleProvider"
set ALGORITHM="algorithm=PBEWithSHA256AND256BITAES-CBC-BC"
...
:execute
%JAVA_EXECUTABLE% -classpath %EXEC_CLASSPATH% %EXECUTABLE_CLASS% %SCRIPT_NAME% %JCE_PROVIDER% %ALGORITHM% %*
