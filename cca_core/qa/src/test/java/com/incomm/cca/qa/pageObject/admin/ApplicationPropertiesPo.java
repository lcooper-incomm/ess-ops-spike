 ...
 */
public class ApplicationPropertiesPo extends ControlPanelPo {
    ...
    public ApplicationPropertiesPo(AqatDriver driver) {
        super(driver);
    }

    public Boolean isApplicationPropertiesDisplayed() {
