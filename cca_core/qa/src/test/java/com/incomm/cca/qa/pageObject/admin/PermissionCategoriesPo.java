 ...
 */
public class PermissionCategoriesPo extends ControlPanelPo {
    ...
    public PermissionCategoriesPo(AqatDriver driver) {
        super(driver);
    }

    public Boolean isPermissionCategoriesDisplayed() {
