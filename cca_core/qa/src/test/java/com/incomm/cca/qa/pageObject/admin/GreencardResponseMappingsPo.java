 ...
 */
public class GreencardResponseMappingsPo extends ControlPanelPo {
    ...
    public GreencardResponseMappingsPo(AqatDriver driver) {
        super(driver);
    }

    public Boolean isGreencardResponseMappingsDisplayed() {
