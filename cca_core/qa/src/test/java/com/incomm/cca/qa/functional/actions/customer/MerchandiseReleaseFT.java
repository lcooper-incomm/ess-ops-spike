...
public class MerchandiseReleaseFT extends BaseFT {
    ...
    private Object[][] merchandiseRelease() {
        return new Object[][]{
                ...
                {"Merchant Release of GC Card In 'Bad Credit' Option: Denied", "4453926664", "Denied", "Letter Not Legitimate", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), true, true, false},
                {"Merchant Release of GC Card In 'Bad Credit' Option: Approved", "4453926664", "Approved", "Letter Received", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), true, true, true},
                {"Merchant Release of GC Card In 'Bad Credit' Option: Denied", "4453926664", "Denied", "Bad Merchant", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), true, true, false},
                {"Merchant Release of GC Card In 'Bad Credit' Option: Denied", "4453926664", "Denied", "Merchant Letter Not Received", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), true, true, false},
                {"Merchant Release of GC Card In 'Bad Credit' Option: Denied", "4453926664", "Denied", "Returned Funds", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), true, true, false},
                {"Merchant Release of GC Card In 'Bad Credit' Option: Approved", "4453926664", "Approved", "Letter Received", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), false, false, true},
                {"Merchant Release of GC Card In 'Deactive' Option: Approved", "4453926664", "Approved", "Letter Received", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), false, false, true},
                {"Merchant Release of GC Card In 'Bad Credit' Without Permission", "4453926664", "Approved", "Letter Received", UserData.AGENT3.getUsername(), UserData.AGENT3.getPassword(), true, false, true},
        };
    }
}
