 ...
 */
public class BalanceAdjustmentLimitsPo extends ControlPanelPo {
    ...
    public BalanceAdjustmentLimitsPo(AqatDriver driver) {
        super(driver);
    }

    public Boolean isBalanceAdjustmentLimitsDisplayed() {
