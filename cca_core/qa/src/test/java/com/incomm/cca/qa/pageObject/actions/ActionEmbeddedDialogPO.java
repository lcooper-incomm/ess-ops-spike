...
/**
 * Represents an action framework "dialog" that's embedded into the page.
 */
public abstract class ActionEmbeddedDialogPO extends BasePo {

    /*
    LOCATORS
     */
    public final static String ATTRIBUTE_DIALOG_PAGE = "data-qa-dialog-page";
    public final static String DIALOG_CONTAINER_ID = "action-embedded-dialog";
    ...
    public final static String DIALOG_HEADER_ID = "action-embedded-dialog-header";
    ...
    public final static String DIALOG_SPINNER_XPATH = "//div[contains(@class, 'spinner-action-spinner')]";
    /*
    WEB ELEMENTS
     */
    ...
    public ActionEmbeddedDialogPO(AqatDriver driver) {
        super(driver);
