 ...
 */
public class GreencardRequestMappingsPo extends ControlPanelPo {
    ...
    public GreencardRequestMappingsPo(AqatDriver driver) {
        super(driver);
    }

    public Boolean isGreencardRequestMappingsDisplayed() {
