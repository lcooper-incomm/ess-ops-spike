...
public class VanillaSearchAT extends BaseFT {
    ...
    public void verifyFields(String description, String field, String value, String result) {
        ...
        search.selectSearchType(SearchType.VANILLA);
        VanillaSearchParametersPO vanillaSearchParameters = new VanillaSearchParametersPO(driver);

        switch (field) {
            case "Account Number":
                vanillaSearchParameters.search(field, value);
