 ...
 */
public class CreditLocationShortPayListPo extends ControlPanelPo {
    ...
    public CreditLocationShortPayListPo(AqatDriver driver) {
        super(driver);
    }

    public Boolean isCreditLocationShortPayListDisplayed() {
